    ...
    <>
        ...
        <div className="container">
          ...
          <nav>
            <ul className="nav-links">
              ...
              <li><a href="https://github.com/kennethgefferson-blip/React-Proyecto" target="_blank" rel="noopener noreferrer" className="nav-github"><GithubIcon size={16} /><span>GitHub</span></a></li>
            </ul>
          </nav>
      ...
      <div className={`mobile-nav ${mobileOpen ? 'open' : ''}`}>
        ...
        <ul className="mobile-nav-links">
          ...
          <li><a href="https://github.com/kennethgefferson-blip/React-Proyecto" target="_blank" rel="noopener noreferrer" className="mobile-nav-link mobile-nav-github"><GithubIcon size={18} style={{ marginRight: '8px', verticalAlign: 'middle' }} /><span>GitHub</span></a></li>
        </ul>
      </div>
    </>
  );
